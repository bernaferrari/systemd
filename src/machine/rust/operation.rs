...
//
// PORT-SYNC: src/machine/operation.c
//
...
pub const SOURCE_PATH: &str = "src/machine/operation.c";
pub const EXTRACTED_FUNCTIONS: &[&str] = &[
    "operation_attach_bus_reply",
    "operation_attach_varlink_reply",
    "operation_done",
    "operation_free",
    "operation_new",
    "read_operation_errno"
];
