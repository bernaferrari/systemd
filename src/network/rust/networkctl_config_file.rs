...
//
// Port of networkctl-config-file.c
//
...
mod tests {
    ...
    #[test]
    fn test_networkctl_config_file_enums() {
        let _ = std::mem::size_of::<ReloadFlags>();
        let _ = std::mem::size_of::<LinkConfigType>();
    }
}
