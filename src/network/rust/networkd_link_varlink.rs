...
//
// Port of networkd-link-varlink.c
//
...
#[repr(C)]
pub enum DispatchLinkFlag {
    DispatchLinkPolkit,
    DispatchLinkMandatory,
}
...
mod tests {
    ...
    #[test]
    fn test_networkd_link_varlink_enums() {
        let _ = std::mem::size_of::<DispatchLinkFlag>();
    }
}
