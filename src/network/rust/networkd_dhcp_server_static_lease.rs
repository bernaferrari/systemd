...
//
// Port of networkd-dhcp-server-static-lease.c
//
...
mod tests {
    ...
    #[test]
    fn test_networkd_dhcp_server_static_lease_structs() {
        let _ = std::mem::size_of::<DHCPStaticLease>();
    }
}
