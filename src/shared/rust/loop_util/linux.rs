...
use super::model::{
    LoopError, LoopFlags, LOCK_EX, LOCK_NB, LOCK_SH, LO_FLAGS_AUTOCLEAR, LO_FLAGS_DIRECT_IO,
    LO_FLAGS_PARTSCAN, LO_FLAGS_READ_ONLY, MAX_ATTEMPTS, O_CLOEXEC, O_NOCTTY, O_NONBLOCK, O_RDONLY,
    O_RDWR,
};
use std::ffi::CString;
use std::fs;
