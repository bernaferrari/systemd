...
mod tests {
    ...
    #[test]
    fn run_orchestration_keeps_inactive_modes_side_effect_free() {
    ...
    #[test]
    fn run_orchestration_validates_path_before_all_backend_operations() {
        let args = VolatileRootArgs {
    ...
    #[test]
    fn run_orchestration_stops_after_preflight_failure() {
        let args = VolatileRootArgs {
    ...
    #[test]
    fn run_orchestration_reports_temporary_sysroot_without_recording_or_mounting() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Overlay,
            path: "/sysroot".into(),
        };
    ...
    #[test]
    fn run_orchestration_matches_c_yes_order_from_preflight_to_transition() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Yes,
            path: "/sysroot".into(),
        };
    ...
    #[test]
    fn run_orchestration_skips_missing_backing_device_and_dispatches_overlay() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Overlay,
            path: "/sysroot".into(),
        };
    ...
    #[test]
    fn run_orchestration_makes_link_failure_warning_only_before_transition() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Yes,
            path: "/sysroot".into(),
        };
    ...
    #[test]
    fn run_orchestration_stops_before_transition_when_discovery_fails() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Overlay,
            path: "/sysroot".into(),
        };
    ...
    #[test]
    fn run_orchestration_preserves_transition_failure_after_warning() {
        let args = VolatileRootArgs {
            mode: VolatileMode::Overlay,
            path: "/sysroot".into(),
        };
