...
TEST(factory_reset_mode_to_string) {
        ...
        ASSERT_STREQ(factory_reset_mode_to_string(FACTORY_RESET_PENDING), "pending");
}

TEST(factory_reset_mode_from_string) {
        ...
        ASSERT_EQ(factory_reset_mode_from_string("pending"), FACTORY_RESET_PENDING);
