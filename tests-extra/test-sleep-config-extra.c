...
TEST(sleep_operation_to_string) {
        ...
        ASSERT_STREQ(sleep_operation_to_string(SLEEP_SUSPEND_THEN_HIBERNATE), "suspend-then-hibernate");
}

TEST(sleep_operation_from_string) {
        ...
        ASSERT_EQ(sleep_operation_from_string("suspend-then-hibernate"), SLEEP_SUSPEND_THEN_HIBERNATE);
