...
TEST(factory_reset_mode_roundtrip) {
        ...
        assert_se(factory_reset_mode_from_string("unspecified") == FACTORY_RESET_UNSPECIFIED);
        ...
        /* Invalid */
        assert_se(factory_reset_mode_from_string("invalid") == _FACTORY_RESET_MODE_INVALID);
        assert_se(factory_reset_mode_from_string("") == _FACTORY_RESET_MODE_INVALID);
}
